...
export default function Button({
  ...
  const baseClasses =
    "relative cursor-pointer overflow-hidden h-[40px] px-2 py-2 rounded-[4px] flex items-center justify-center gap-3 font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed box-border";
